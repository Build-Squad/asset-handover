...
transaction {
    ...
    execute {
        ...
        var nonFungibleTokenInfo = AssetHandover.NonFungibleTokenInfo(
            ...
            privateType: Type<&ExampleNFT.Collection{ExampleNFT.ExampleNFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>()
        )
